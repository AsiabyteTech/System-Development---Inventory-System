...
const AddEditPromo = () => {
    ...
    // ✅ ADDED: auto promo ID state (PRO format)
    ...
    // ✅ ADDED: auto-generate promo ID when component loads (PRO format)
    useEffect(() => {
                ...
                <div className="form-grid grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 relative z-10">
                    <div className="space-y-4 sm:space-y-5">
                        <div>
                            ...
                            {/* ✅ UPDATED: auto-generated promo ID (readonly) with PRO format */}
                            <input
                                type="text"
                                value={promoId}
                                readOnly
