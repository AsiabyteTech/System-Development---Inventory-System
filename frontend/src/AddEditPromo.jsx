...
const AddEditPromo = () => {
  ...
  return (
    <div className="containersys min-h-screen bg-slate-50">
                ...
                <div className="form-grid grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 relative z-10">
                    <div className="space-y-4 sm:space-y-5">
                        <div>
                            ...
                            <input type="text" placeholder="Enter Promotion ID" className="form-input w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm" />
                        </div>
                        <div>
                    ...
                    <div className="space-y-4 sm:space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Enter Reduction" className="form-input w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm" />
                        </div>
                        <div>
        ...
        {/* ✅ RESPONSIVE FIX: Delete Confirmation Modal - responsive sizing */}
        {showDeleteConfirm && (
