...
const AddEditPackage = () => {
    ...
    // Fetch products from API with inventory data
    const fetchProducts = async () => {
        try {
            ...
            const mappedProducts = productData.map(item => {
                console.log(`Product ${item.SKU || item.sku} - QuantityOnHand:`, item.QuantityOnHand);
            ...
            console.log('Mapped products with quantities:', mappedProducts);
    ...
    const handleDelete = async () => {
        try {
            ...
            alert(err.response?.data?.detail || err.message || "Failed to delete package");
        }
    };
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            alert(err.response?.data?.detail || err.message || "Failed to save package. Please try again.");
        } finally {
            setSaving(false);
        }
    };
