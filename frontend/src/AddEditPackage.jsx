                ...
                <div className="form-section-card bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 mb-8 border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="form-grid grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="space-y-5">
                            <div>
                                <label className="input-label text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 block">Package ID</label>
                                <input type="text" placeholder="Enter Package ID" className="form-input w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"/>
                            </div>
                            <div>
                                <label className="input-label text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 block">Package Name</label>
                                <input type="text" placeholder="Enter Package Name" className="form-input w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" />
                            </div>
                            <div>
