...
const Supplier = () => {
  ...
  const checkScrollPosition = () => {
    ...
    const scrollPercent = scrollWidth > 0 ? container.scrollLeft / scrollWidth : 0;
                  ...
                  {suppliers.map((s, idx) => (
                    ...
                    >
                      <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-lg flex items-center justify-center bg-white overflow-hidden">
                        <img src={s.logo} alt={s.name} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 object-contain" />
                      </div>
          ...
          <div className="relative z-10">
            ...
            <div className="form-grid grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              <div className="space-y-2">
                ...
                <input type="text" disabled defaultValue={current.id} className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700 font-medium text-sm" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" disabled={!isAdmin()} defaultValue={current.phone} className="w-full pl-8 sm:pl-10 pr-4 py-2 sm:py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700 disabled:bg-slate-100 disabled:cursor-not-allowed text-sm" />
                </div>
              </div>
            </div>
          </div>
