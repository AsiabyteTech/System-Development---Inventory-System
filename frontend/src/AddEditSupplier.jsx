      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col relative overflow-hidden animate-fadeIn">
        ...
        <div className="px-6 py-5 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-blue-50 to-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">{mode === 'edit' ? 'Edit Supplier' : 'Add New Supplier'}</h2>
          ...
          <button 
            onClick={onClose} 
            className="close-btn-minimal hover:bg-gray-100 p-2 rounded-full transition-all duration-200"
          >
        ...
        {/* Modal Body - Enhanced with better spacing and design */}
