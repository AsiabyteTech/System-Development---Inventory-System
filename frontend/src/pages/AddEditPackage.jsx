...
const AddEditPackage = () => {
    ...
    const [reduction, setReduction] = useState(""); // ✅ Added reduction state
    ...
    useEffect(() => {
        if (editMode && packageData && products.length > 0) {
            ...
            setReduction(packageData.Reduction || packageData.reduction || ''); // ✅ Load reduction
    ...
    // ✅ Calculate final price after reduction (NEW)
    const reductionValue = (totalMargin * (parseFloat(reduction) || 0)) / 100;
    const finalPrice = totalMargin - reductionValue;

    // ✅ Auto update package price when margin or reduction changes (UPDATED)
    useEffect(() => {
    ...
    const handleSave = async () => {
        ...
        // ✅ Added Reduction to package data
        const packageDataToSave = {
            PackageName: packageName,
            Dateline: packageDateline,
            Price: parseFloat(packagePrice),
            Reduction: parseFloat(reduction) || 0, // ✅ Added reduction
                    ...
                    <div className="relative z-10">
                        <div className="form-grid grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                            <div className="space-y-4 sm:space-y-5">
                                ...
                                {/* ✅ Reduction Percentage Input (NEW) */}
                                <div>
                            ...
                            <div className="space-y-4 sm:space-y-5">
                                ...
                                {/* ✅ Pricing Summary Card (UPDATED with reduction) */}
                                {(hasSelectedItems || editMode) && (
