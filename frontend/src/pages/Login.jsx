  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="auth-container w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12 flex flex-col lg:flex-row items-center justify-center min-h-screen relative z-10">
        ...
        {/* ✅ RESPONSIVE FIX: Login Form Section - responsive sizing */}
        <div className="form-section w-full max-w-md lg:max-w-md xl:max-w-lg mx-auto lg:mx-0 animate-fade-in-up animation-delay-400">
          <div className="auth-card bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 p-6 sm:p-8 relative overflow-hidden">
            ...
            <header className="card-header mb-6">
              {/* ✅ RESPONSIVE FIX: Responsive text sizes */}
              <h2 className="text-xl sm:text-2xl font-bold text-slate-800">Welcome!</h2>
              <p className="text-slate-500 font-medium mt-1 text-sm sm:text-base">Please enter your Email Address and password to sign in.</p>
            </header>
            ...
            <form className="auth-form space-y-5" onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-4 h-4 text-blue-600 bg-white border-slate-300 rounded focus:ring-blue-500 focus:ring-2 transition-all flex-shrink-0" />
