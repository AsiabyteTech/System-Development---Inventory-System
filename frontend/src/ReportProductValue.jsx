            ...
            <main className="all-main-content">
                <div className="addedit-banner-row">
                    <div className="title-banner">
                        ...
                        <h2 className="banner-title print:text-black print:bg-transparent print:shadow-none print:px-0">Total Product Value</h2>
                    </div>
                        ...
                        <div className="p-6 print:p-4">
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-medium text-blue-100 uppercase tracking-wider print:text-gray-600">Total Product Value</span>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-3xl font-bold text-white print:text-gray-900">RM {totalProductValue.toFixed(2)}</h3>
                                <p className="text-sm text-blue-100 print:text-gray-500">Total inventory value for {formattedMonth}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-slate-100 overflow-hidden print:bg-white print:shadow-none print:border print:border-gray-200">
                        <div className="p-6 print:p-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-sm text-slate-500 print:text-gray-600">{filteredStocks.length} items found</p>
                ...
                <div className="space-y-6 mb-8 print:space-y-4">
                    ...
                    <div className="bg-blue-50/30 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-blue-100 print:bg-white print:shadow-none print:border print:border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 print:text-gray-700">Quantity On Hand</label>
                                <input
                                    type="number"
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="bg-gradient-to-r from-blue-900 to-blue-700 text-white print:bg-gray-100 print:text-gray-900">
                                    ...
                                    <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Invoice Date</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Staff</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Price (RM)</th>
                                </tr>
                            </thead>
                                ...
                                {filteredStocks.length > 0 ? (
                                    filteredStocks.map((item) => (
                                        <tr key={item.id} className="hover:bg-blue-50/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-slate-600 print:text-gray-700 print:px-4 print:py-2">{item.invoiceDate}</td>
                                            <td className="px-6 py-4 text-slate-600 print:text-gray-700 print:px-4 print:py-2">{item.staffName}</td>
                                            <td className="px-6 py-4 font-medium text-slate-700 print:text-gray-700 print:px-4 print:py-2">RM {item.price}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
