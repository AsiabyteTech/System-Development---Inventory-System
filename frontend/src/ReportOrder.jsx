        ...
        <div className="min-h-screen bg-slate-50 flex flex-col print:bg-white">
            ...
            <header className="bg-white border-b border-slate-200/60 shadow-sm py-2 sm:py-3 px-4 sm:px-6 print:hidden">
             ...
             <main className="all-main-content px-3 sm:px-6 py-4 sm:py-6">
                ...
                {/* ✅ RESPONSIVE FIX: Stats Cards Row - responsive grid and padding */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 print:grid-cols-3 print:gap-4">
                    {/* Total Order Card */}
                        ...
                        <div className="p-4 sm:p-6 print:p-4">
                            <div className="flex items-start justify-between mb-3 sm:mb-4">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <span className="text-[11px] sm:text-sm font-medium text-blue-100 uppercase tracking-wider print:text-gray-600">Total Order</span>
                                </div>
                            </div>
                            <div className="space-y-1 sm:space-y-2">
                                <h3 className="text-2xl sm:text-3xl font-bold text-white print:text-gray-900">{totalOrders}</h3>
                                <p className="text-xs sm:text-sm text-blue-100 print:text-gray-500">Orders for {formattedMonth}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-4 sm:p-6 print:p-4">
                            <div className="flex items-start justify-between mb-3 sm:mb-4">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <span className="text-[11px] sm:text-sm font-medium text-blue-100 uppercase tracking-wider print:text-gray-600">Total Order Value</span>
                                </div>
                            </div>
                            <div className="space-y-1 sm:space-y-2">
                                <h3 className="text-xl sm:text-3xl font-bold text-white print:text-gray-900">RM {totalOrderValue.toFixed(2)}</h3>
                                <p className="text-xs sm:text-sm text-blue-100 print:text-gray-500">Revenue for {formattedMonth}</p>
                            </div>
                        </div>
                    </div>
                    
                    {/* Date Card - White Theme with Filter */}
                    <div className="sm:col-span-2 lg:col-span-1 group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-slate-100 overflow-hidden print:bg-white print:shadow-none print:border print:border-gray-200">
                        <div className="p-4 sm:p-6 print:p-4">
                            <div className="flex items-start justify-between mb-3 sm:mb-4">
                                <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                ...
                                <p className="text-xs sm:text-sm text-slate-500 print:text-gray-600">{filteredReports.length} orders found</p>
                ...
                <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8 print:space-y-4">
                    ...
                    <div className="bg-blue-50/30 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-4 sm:p-6 border border-blue-100 print:bg-white print:shadow-none print:border print:border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                <label className="block text-[10px] sm:text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 print:text-gray-700">Status</label>
                                <input 
                                    type="text" 
                    ...
                    <div className="bg-blue-50/30 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-4 sm:p-6 border border-blue-100 print:bg-white print:shadow-none print:border print:border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            <div>
                                <label className="block text-[10px] sm:text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 print:text-gray-700">Quantity On Hand (Balance)</label>
                                <input 
                                    type="number" 
                            ...
                            <div>
                                <label className="block text-[10px] sm:text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 print:text-gray-700">Reserved Quantity (Sold)</label>
                                <input 
                                    type="number" 
                            ...
                            <div>
                                <label className="block text-[10px] sm:text-xs font-semibold text-slate-600 uppercase tracking-wider mb-2 print:text-gray-700">Margin</label>
                                <input 
                                    type="text" 
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gradient-to-r from-blue-900 to-blue-700 text-white print:bg-gray-100 print:text-gray-900">
                                        ...
                                        <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-[10px] sm:text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Stock Out</th>
                                        <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-[10px] sm:text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Tracking Number</th>
                                        <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-[10px] sm:text-xs font-semibold uppercase tracking-wider print:px-4 print:py-2">Status</th>
                                    </tr>
                                </thead>
                                    ...
                                    {filteredReports.length > 0 ? (
                                        filteredReports.map((item) => (
                                            <tr key={item.id} className="hover:bg-blue-50/50 transition-colors">
                                                ...
                                                <td className="px-3 sm:px-6 py-3 sm:py-4 text-slate-600 text-sm sm:text-base print:text-gray-700 print:px-4 print:py-2">{item.inoutDate}</td>
                                                <td className="px-3 sm:px-6 py-3 sm:py-4 text-slate-600 text-sm sm:text-base print:text-gray-700 print:px-4 print:py-2">{item.trackingNumber || '-'}</td>
