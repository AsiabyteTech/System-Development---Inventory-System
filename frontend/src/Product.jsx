                                            ...
                                            <tr key={item.id} className="hover:bg-blue-50/50 transition-colors">
                                                ...
                                                <td className="px-2 sm:px-3 md:px-6 py-2 sm:py-3 md:py-4">
                                                    <img 
                                                        src={item.image} 
                                                        alt="Product" 
                                                        className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 object-cover rounded-lg shadow-sm cursor-pointer hover:scale-110 transition-transform duration-300" 
